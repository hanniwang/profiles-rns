...
namespace Profiles.Proxy.Modules.SearchSuperProxies
{
    public partial class SearchSuperProxies : BaseModule
    {
        ...
        public SearchSuperProxies() { }
        public SearchSuperProxies(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        {
        ...
        protected void btnSearchReset_Click(object sender, EventArgs e)
        {
            ...
            //TODO: reset the stuff I just added for super Proxy support
        }
