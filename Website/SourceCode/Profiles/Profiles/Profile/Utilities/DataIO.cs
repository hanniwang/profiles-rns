...
namespace Profiles.Profile.Utilities
{
    public class DataIO : Profiles.Framework.Utilities.DataIO
    {
        ...
        public void editNarrativePanel(string personid, string newText)
        {
            ...
            try
            {
                ...
                dbcommand.CommandText = "[Profile.Data].[Narrative.EditNarrativeByPersonID]";
                dbcommand.CommandTimeout = base.GetCommandTimeout();

                dbcommand.Parameters.Add(new SqlParameter("@PersonID", personid));
                dbcommand.Parameters.Add(new SqlParameter("@TextVal", newText));
        ...
        public string getNarrativeTextByPersonID(string personid)
        {
            SqlDataReader dbreader = null;
            ...
            try
            {
                ...
                dbcommand.CommandText = "[Profile.Data].[GetNarrativeByPersonID]";
                dbcommand.CommandTimeout = base.GetCommandTimeout();
                ...
                if(dbreader.Read())
                    narrativeText = dbreader["Text"].ToString();
                dbreader.Close();
