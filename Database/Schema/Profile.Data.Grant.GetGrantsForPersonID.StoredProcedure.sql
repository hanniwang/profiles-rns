...
SELECT g.GrantID as ID, g.GrantTitle as Title, g.GrantAmount as Amount, CONVERT(VARCHAR(10), g.StartDate, 103) as StartDate, CONVERT(VARCHAR(10), g.EndDate, 103) as EndDate
  FROM (
